            ...
            <div class="row">
                <div class="card overflow-hidden">
                        <div class="card-body p-4">
                            <h6 class="card-title mb-9 fw-semibold">Approval Perjalanan Dinas</h6>
                            <div class="row">
                                <div class="col">
                            ...
                            <div class="row mt-4">
                                <div class="col">
                                    <div class="d-grid gap-2">
                                        <a class="btn btn-danger " href="{{route('reject', $perjalanan->id)}}" >Reject</a>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="d-grid gap-2">
                                        <a class="btn btn-primary " href="{{route('acc', $perjalanan->id)}}" >Approve</a>
                                    </div>
                                </div>
                            </div>
                        </div>
